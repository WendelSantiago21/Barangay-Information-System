...
<header>
    <nav class="topnav" id="mytopnav">
		...
		<a href="request-records.php">Request Records
		</a>
...
function closeNav() {
  document.getElementById("mySidenav").style.width = "0";
        ...
        <a href="resident-records.php">Resident Records</a>
        <a href="newresident.php">New <br>Resident</a>
		<a href="#">Activity <br>Records</a>
		<a href="request-records.php">Request Records</a>
		<a href="indexlogout.php">Logout</a>
		</div>
...
function closeNav() {
  document.getElementById("mySidenav").style.width = "0";
        ...
        <a href="newresident.php">New <br>Resident</a>
		<a href="#">Activity <br>Records</a>
		<a href="requestrecords.php">Request Records</a>
		<a href="indexlogout.php">Logout</a>
		</div>
		<span style="font-size:30px;cursor:pointer;position:fixed;margin-left:20px;" onclick="openNav()">&#9776;</span>
		<script>
...
<div class="hero">
    <div class="container">
	    ...
	    <img src="logo.png">
            <h2 class="hero-heading">WELCOME TO BARANGAY 489 <br>ZONE 48 DISTRICT VI </h2>
            <p class="hero-text">WEB DEVELOPER<br>PASTORAL, PORTALES & PRING</p>
            <p class="hero-text">DATA ADMINISTRATOR</p>
      ...
      <div class="feature-row">
        <div class="feature">
          <div class="feature-content">
            ...
            <p class="feature-text">VIA EMAIL: 1234@gmail.com</p>
            <p class="feature-text">VIA EMAIL: https://www.facebook.com/profile.php?id=100095092554915</p>
          </div>
        </div>
        <center>
        <div class="container">
    <h2 class="section-title">About Barangay Information System</h2><br>
