...
<body style="background-image: url('com-picaai.png'); background-repeat: no-repeat; background-size: 2050px 900px;">
	<div class="form">
        ...
        <div class="button-group">
            <button class="button-confirm cancel" onclick="redirectToHome()">Cancel</button>
            <button class="button-confirm" onclick="submitForm()">Request</button>
        </div>
		<script>
        ...
        function submitForm() {
            localStorage.setItem("formSubmitted", "Your request has been successfully sent!");
            window.location.href = "indexlogin.php";
        }
		</script>
		</form>
