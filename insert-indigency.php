...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = mysqli_prepare($link, "INSERT INTO tblindigency (name, age, address, status, purpose) VALUES (?, ?, ?, ?, ?)");
    ...
    if ($stmt) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            echo "<script>alert('Your request has been successfully submitted!'); window.location.href='request_indigency.php';</script>";
        } else {
