...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = mysqli_prepare($link, "INSERT INTO tblclearance (name, age, address, status, purpose) VALUES (?, ?, ?, ?, ?)");
    ...
    if ($stmt) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            echo "<script>alert('Your request has been successfully submitted!'); window.location.href='request_clearance.php';</script>";
        } else {
