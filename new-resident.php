...
function closeNav() {
  ...
  <div class="form">
    <div class="resident-form">
      ...
      <div class="picture image-upload" id="preview-container">
        <img id="preview" src="" alt="Image Preview">
      </div>
      <div class="form-group">
        <input type="file" class="file" id="imageInput" name="imageInput" accept="image/jpeg" required>
      </div>
        <div class="row">
          <div class="row-form">
            <div class="form-group">
	...
	<div class="form-group">
		...
		<div class="voter">
            <div class="form-group">
              <label for="voterstatus"><strong>VOTER STATUS:</strong></label>
          ...
          <div style="text-align: center; margin-top: 20px;">
            <button type="submit" id="submitResidentBtn" style="background-color: red; color: white; padding: 10px 25px; font-size: 18px; border: none; border-radius: 5px; cursor: pointer;">
              Add Resident
            </button>
          </div>
        </div>
  ...
  form.onsubmit = function (e) {
    ...
    .then(response => {
      if (response.includes("success")) {
        alert("New Resident Record Added!");
        form.reset();
