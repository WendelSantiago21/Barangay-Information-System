...
<head>
    ...
    <title>Request a Indigency</title>
</head>
<header>
	<div class="header1">
		<h2>BARANGAY 489 ZONE 48 DISTRICT VI (REQUEST AN INDIGENCY)</h2>
	</div>
</header>
...
<div class="form">
    ...
    <form method="POST" action="insert-indigency.php" id="indigencyForm">
        <div class="form-grid">
